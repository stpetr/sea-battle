...
router.post('/api/game/:id/join', auth, async (req, res) => {
    ...
    if (gameData.opponent) {
        ...
        sockets.notifyUser(gameData.opponent._id, 'opponentJoined', { data: opponentGameData, message: 'Opponent has joined the game' })
    }
})
...
router.post('/api/game/:id/set-ships', auth, async (req, res) => {
    ...
    if (gameData.opponent) {
        const opponentGameData = await Game.prepareGameData(game, gameData.opponent)
        sockets.notifyUser(gameData.opponent._id, 'opponentSetShips', { data: opponentGameData, message: 'Opponent has set his ships' })
    }
